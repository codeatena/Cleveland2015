...
- (void) loadPushPin
{
	...
	else
	{
        ...
        for (int i =0; i < size; i++) {
            ...
            NSNumber *latNumber = [f numberFromString:[[line objectAtIndex:5] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]]];
            NSNumber *lonNumber = [f numberFromString:[[line objectAtIndex:6] stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]]];
...
- (void) loadImagePin
{
	...
	else
	{
		...
		for (int i = 0; i < sizePics; i++)
		{
            ...
            pin.address = [linePics objectAtIndex: 4];
